#
#  Be sure to run `pod spec lint SwiftyCalls.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Shivansh Gaur" => "shivanshgaur96@gmail.com" }
  # Or just: spec.author    = "Shivansh Gaur"
  # spec.authors            = { "Shivansh Gaur" => "shivansh.gaur@blackngreen.com" }
  # spec.social_media_url   = "https://twitter.com/Shivansh Gaur"
  ...
  spec.source_files = "SwiftyCalls/**/*.{swift,h,m}"
  # spec.exclude_files = "Classes/Exclude"

  # If using an xcframework
